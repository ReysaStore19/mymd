 ...
 *Powered By @${'628125154989('.split('@')[0]}*`
 ...
 const ftroli = {
    ...
    status: 1,
    surface : 1,
    message: `ReysaBoTz By Reysa Yandex`, 
    orderTitle: `▮Menu ▸`,
...
Saya Adalah ReysaBoTz Salah Satu Bot Whatsapp Yang Siap Membantu Kamu Mempermudah Sesuatu Seperti Membuat Sticker Dan Lainnya, Kalo Kamu Mau Request Fitur Silahkan Ketik #request Pesan Atau Fitur Yang Kamu Inginkan!`
...
                 .replace(/%islimit/g, menu.limit ? 'Ⓛ' : '')
 ...
         externalAdReply: { 
             title: 'ReysaBoTz Testing Project By Reysa Yandex', 
